...
class GA:
    ...
    def mutate(self):
        if np.random.rand() < self.p_mutation:
            ...
            mutated_dna = np.array([[mutation["b"], mutation["h"], mutation["Ast_dia"], mutation["Asc_dia"],
                                     mutation["fcu"], mutation["fy"], mutation["brand"], mutation["fitness"]]])
            return mutated_dna
